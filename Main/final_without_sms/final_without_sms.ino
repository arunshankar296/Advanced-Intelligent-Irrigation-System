...
namespace Config {
  ...
  const unsigned int PEAK_TIME_END   = 1201;    // 7:00 PM (19:00)
  ...
  const int WELL_MAX_LEVEL = 100; // Level to resume pump after low water condition
  ...
  const unsigned int DRIP_MORNING_START = 1230;  // 5:00 AM
  const unsigned int DRIP_MORNING_END   = 1631;  // 7:30 AM
  const unsigned int DRIP_EVENING_START = 2330; // 4:00 PM
  const unsigned int DRIP_EVENING_END   = 2332; // 6:30 PM
